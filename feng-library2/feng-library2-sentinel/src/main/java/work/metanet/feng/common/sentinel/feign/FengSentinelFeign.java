package work.metanet.feng.common.sentinel.feign;
 ...
 * @date 2020/6/9
 */
public final class FengSentinelFeign {

    private FengSentinelFeign() {

    }

    public static FengSentinelFeign.Builder builder() {
        return new FengSentinelFeign.Builder();
    }
    ...
    public static final class Builder extends Feign.Builder implements ApplicationContextAware {
        ...
        @Override
        public FengSentinelFeign.Builder contract(Contract contract) {
            ...
            super.invocationHandlerFactory(new InvocationHandlerFactory() {
                ...
                public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
                    ...
                    if (void.class != fallback) {
                        ...
                        return new FengSentinelInvocationHandler(target, dispatch, new FallbackFactory.Default(fallbackInstance));
                    }
                    if (void.class != fallbackFactory) {
                        ...
                        return new FengSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
                    }
                    return new FengSentinelInvocationHandler(target, dispatch);
                }
