package work.metanet.feng.common.file.utils;

import cn.hutool.core.util.StrUtil;
import org.springframework.util.StringUtils;

/**
 * @ClassName FileContentTypeUtils
 * @Deacription 根据文件后缀获取文件ContentType
 * @author edison
 * @Date 2021/7/2 14:12
 **/
public class FileContentTypeUtils {
    ...
    public static String getContentType(String fileName) {
        String s = imgTypeValid(fileName);
        if (StrUtil.isBlank(s)) {
            return "image/jpeg";
        }
        String contentType = contentType(s);
        return contentType;
    }
