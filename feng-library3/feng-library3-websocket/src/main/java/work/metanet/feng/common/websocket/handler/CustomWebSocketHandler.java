...
import work.metanet.feng.common.websocket.holder.JsonMessageHandlerHolder;
import work.metanet.feng.common.websocket.message.AbstractJsonWebSocketMessage;
...
public class CustomWebSocketHandler extends TextWebSocketHandler {
    ...
    public void handleTextMessage(WebSocketSession session, TextMessage message) throws JsonProcessingException {
        ...
        try {
            ...
            log.error("[handleTextMessage] 普通文本消息（{}）没有对应的消息处理器", message.getPayload());
        }
    }
