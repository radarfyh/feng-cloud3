package ltd.huntinginfo.feng.common.sentinel.feign;
 ...
 */
@Slf4j
public class FengSentinelInvocationHandler implements InvocationHandler {
    ...
    FengSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch, FallbackFactory fallbackFactory) {
    ...
    FengSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch) {
        this.target = checkNotNull(target, "target");
        this.dispatch = checkNotNull(dispatch, "dispatch");
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SentinelInvocationHandler) {
        	FengSentinelInvocationHandler other = (FengSentinelInvocationHandler) obj;
