package work.metanet.feng.common.idempotent.aspect;

import work.metanet.feng.common.idempotent.annotation.Idempotent;
import work.metanet.feng.common.idempotent.exception.IdempotentException;
...
public class IdempotentAspect {
    ...
    @Pointcut("@annotation(work.metanet.feng.common.idempotent.annotation.Idempotent)")
