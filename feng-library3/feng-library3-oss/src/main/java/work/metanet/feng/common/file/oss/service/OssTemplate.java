package work.metanet.feng.common.file.oss.service;
...
import work.metanet.feng.common.file.utils.FileContentTypeUtils;
...
public class OssTemplate implements InitializingBean, FileTemplate {
    ...
    public String getObjectURL(String bucketName, String objectName, Integer expires) {
        boolean isFile = doesObjectExist(bucketName, objectName);
        if (isFile) {
            Date date = new Date();
    ...
    public void putObject(String bucketName, String objectName, InputStream stream) throws Exception {
        String contentType = FileContentTypeUtils.contentType(objectName);
