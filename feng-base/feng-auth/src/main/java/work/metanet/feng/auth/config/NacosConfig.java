...
public class NacosConfig {
    ...
    private String getUsername() {
    	String property = getProperty("spring.cloud.nacos.config.username");
        return property;
    }
    
    private String getPassword() {
    	String property = getProperty("spring.cloud.nacos.config.password");
        return property;
    }
    ...
    private String getRedisPort() {
    	String property = getProperty("spring.redis.port");
        return property;
    }
    
    private String getRedisDatabase() {
    	String property = getProperty("spring.redis.database");
        return property;
    }
    
    private String getRedisPassword() {
    	String property = getProperty("spring.redis.password");
        return property;
    }
