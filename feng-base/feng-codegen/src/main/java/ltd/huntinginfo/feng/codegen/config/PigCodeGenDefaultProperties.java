package ltd.huntinginfo.feng.codegen.config;
...
public class PigCodeGenDefaultProperties implements InitializingBean {
	 ...
	 * 生成代码的包名
	 */
	private String packageName = "ltd.huntinginfo.feng";
	 ...
	 * 生成代码的后端路径
	 */
	private String backendPath = "feng";

	/**
	 * 生成代码的前端路径
	 */
	private String frontendPath = "feng-ui";

	/**
	 * 生成代码的作者
	 */
	private String author = "feng";
