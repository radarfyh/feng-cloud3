 ...
 */
@Data
@Schema(name = "AUS认证日志VO", description = "AUS认证日志视图对象")
public class AusAuthLogVO implements Serializable {
    ...
    @Schema(description = "登录类型：0 个人，1 单位")
    ...
    @Schema(description = "用户账号，和aus loginId相同", example = "admin")
