...
public interface UmpBroadcastReceiveRecordService extends IService<UmpBroadcastReceiveRecord> {
     ...
     * @return 成功标记数量
     */
    int markAsReadByReceiver(String receiverId, String receiverType, List<String> broadcastIds);
     ...
     * @return 未读接收者列表
     */
    List<Map<String, Object>> getUnreadReceivers(String broadcastId, int limit);
