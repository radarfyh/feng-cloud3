...
public interface UmpMsgTemplateService extends IService<UmpMsgTemplate> {
     ...
     * @return 使用统计列表
     */
    List<TemplateUsageVO> getTemplateUsageStatistics(String templateCode);
     ...
     * @return 验证结果
     */
    Map<String, Object> validateTemplateVariables(String templateCode, Map<String, Object> variables);
