...
//        MultipartFile multipartFile = new MockMultipartFile(fromFile.getName(), fromFile.getName(),null, new FileInputStream(fromFile));
//        byte[] bytes = PicUtils.compressPicForScale(multipartFile.getBytes(), 1024);
